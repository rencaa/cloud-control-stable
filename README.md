...
本版面向 Ubuntu 24.04/26.04、2 核 2GB 内存、16GB 硬盘长期运行，在长期在线版基础上补齐任务双端看门狗、消息优先级、协议能力协商、时区/补跑策略、自适应心跳与投屏、轻量告警以及签名灰度升级/回滚。
...
完整命令、HTTPS、灰度切换、备份和回滚请看 [Ubuntu 24.04/26.04 低配小主机部署教程](docs/Ubuntu24低配小主机部署教程.md)。
